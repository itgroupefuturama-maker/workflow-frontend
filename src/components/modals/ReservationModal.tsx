...
const ReservationModal: React.FC<ReservationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 top-16 backdrop-blur-sm flex items-center justify-center z-50 p-4 ">
                      ...
                      <div key={passager.infoId} className="border border-gray-200 rounded-lg overflow-hidden">
                        ...
                        <div className="p-4 space-y-4">
                          {servicesActifs.map((serviceActif: any) => {
                            // Trouver les préférences disponibles pour ce service dans le store
