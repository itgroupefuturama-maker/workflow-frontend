...
function TicketingPage() {
  ...
  const handleOpenDossier = async (dossier: DossierCommun, idModule : string) => {
      ...
      <div className="max-w-[1600px] w-full mx-auto px-6 pt-5 flex flex-col flex-1 overflow-hidden">
        ...
        <div className="shrink-0">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div className="shrink-0">
              <h1 className="text-3xl font-bold text-slate-900 mb-1">Listes de Ticketing</h1>
              <p className="text-slate-500 text-sm">Gérez l'ensemble de vos dossiers ticketing ici.</p>
            </div>
          </div>
                        ...
                        <tr
                          ...
                          onClick={() => {
                            if (firstValidPrest?.id) {
                              handleOpenDossier(dossier, firstValidPrest.id);
                            }
                          }}
