...
import General from './pdf.generation/sections/General';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        <h1 className="text-2xl font-bold mb-4">Paramètres PDF</h1>
        <p>Bienvenue sur la page des paramètres PDF.</p>
