...
export const HotelHeader = ({ numerohotel, navigate,  isDetail = false }) => (
        ...
        <>
         ...
         <header className="flex items-center justify-between">
             <div className="flex items-center text-sm">
               <button
                 onClick={() => navigate(`/dossiers-communs/hotel/pages`, { state: { targetTab: 'hotel' } })}
               ...
               >
                 <span className="font-semibold tracking-wide">Liste des hotels</span>
               </button>
