      ...
      <div className="flex-1 min-w-0 flex flex-col min-h-0">
        ...
        <div className='px-4 bg-slate-200 rounded-b-xl'>
          ...
          <div className="flex items-center justify-between">
            <nav className="flex rounded-lg mb-2 gap-2" aria-label="Tabs">
              <button
          ...
          {!loading && activeTabSousSection === 'lignes' && [...visaEntetes]
            ...
            return (
              <div
                ...
                className="bg-white rounded-xl border border-slate-300 shadow-sm overflow-hidden cursor-pointer hover:shadow-md hover:border-indigo-200 transition-all"
              >
                {/* ── Header card ── */}
                ...
                {entete.visaLigne.length === 0 ? (
                  ...
                  <div className="overflow-x-auto">
                    <table className="min-w-full text-sm">
                      <thead>
                        <tr className="bg-gray-50 border-b border-slate-300">
